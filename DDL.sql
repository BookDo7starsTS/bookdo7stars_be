...
BEGIN
  INSERT INTO books (
    "itemId", isbn, title, author,"pubDate", description, cover, "stockStatus", "categoryId", mileage, 
    "categoryName", publisher, "salesPoint", adult, "fixedPrice", "priceStandard", "priceSales", 
    "customerReviewRank", "queryType"
  )
  VALUES (
    NEW."itemId", NEW.isbn13, NEW.title, NEW.author, NEW."pubDate", NEW.description, NEW.cover, NEW."stockStatus", 
